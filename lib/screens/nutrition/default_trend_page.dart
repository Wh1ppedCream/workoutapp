...
class DefaultTrendPage extends StatefulWidget {
  ...
  const DefaultTrendPage({super.key, required this.title});
          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (context, i) {
                ...
                final placeholderDate = DateTime.now().subtract(
                  Duration(days: i * 3),
                );
                ...
                return Card(
                  child: ListTile(
                    ...
                    subtitle: Text(
                      '${placeholderDate.month}/${placeholderDate.day}/${placeholderDate.year}',
                    ),
                    trailing: IconButton(
