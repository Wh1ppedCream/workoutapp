...
class _FoodCustomizationPageState extends State<FoodCustomizationPage> {
  ...
  // ----- Portion Info state -----
  // Portion lists
  final List<PortionEntry> _basisPortions = [
    PortionEntry(unit: 'gram (g)', amount: 100, grams: 100),
  ];
  ...
  void _prefillIfEditing() {
    ...
    if (w.initialName != null) {
      _nameController.text = w.initialName!;
    }
    if (w.initialBrand != null) {
      _brandController.text = w.initialBrand!;
    }

    if (w.initialCalories != null) {
      _calController.text = _fmtNum(w.initialCalories!);
    }
    if (w.initialProteinG != null) {
      _proteinController.text = _fmtNum(w.initialProteinG!);
    }
    if (w.initialCarbsG != null) {
      _carbController.text = _fmtNum(w.initialCarbsG!);
    }
    if (w.initialFatsG != null) {
      _fatController.text = _fmtNum(w.initialFatsG!);
    }
  ...
  void _loadInitialPortions(List<FoodPortion> parts) {
    ...
    for (final p in _basisPortions) {
      p.dispose();
    }
    for (final p in _usualPortions) {
      p.dispose();
    }
  ...
  Map<String, dynamic> _collectPayload() {
    ...
    for (final e in _controllers.entries) {
      ...
      final last = _stripTrailingGroup(
        path.split(' > ').last,
      ); // -> "Chloride (mg)"
    ...
    if (extendedPaths.isNotEmpty) {
      payload['__extended_paths__'] =
          extendedPaths; // harmless to DAO; future-proof
    }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: Text(strings.foodCustomizationFoodPhoto),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: Text(strings.foodCustomizationLabelPhoto),
                        ),
                      ],
                    ),
                  ),
              ...
              const SizedBox(height: 12),
              _buildNumberField(
                label: strings.foodCustomizationDensity,
              ...
              _buildNumberField(
                label: strings.foodCustomizationCalories,
    ...
    return Card(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          title: Text(
            strings.foodCustomizationPortionInfo,
        ...
        children: [
          ...
          Align(
            ...
            child: TextButton.icon(
              ...
              label: Text(
                AppLocalizations.of(context).foodCustomizationAddPortion,
              ),
            ),
          ),
        ],
...
const List<NutrientNode> _additionalNodes = [
  ...
  NutrientNode('Functional Additives', [
    ...
    NutrientNode('Thickeners (g)', [NutrientNode('Guar gum (g)')]),
...
class PortionEntry {
  PortionEntry({
    ...
    double? ml,
         ...
         text: amount == null ? '' : _fmtNum(amount),
       ),
       gramsCtrl = TextEditingController(
         text: grams == null ? '' : _fmtNum(grams),
       ),
