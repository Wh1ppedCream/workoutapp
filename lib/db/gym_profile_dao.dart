...
class GymProfileDao {
  ...
  static Future<int> insertProfile(Database db, GymProfile profile) async {
  ...
  static Future<int> updateProfile(Database db, GymProfile profile) async {
  ...
  static Future<void> insertProfileEquipment(
    ...
    await db.insert(
      'profile_equipment',
      {'profile_id': profileId, 'equipment_id': equipmentId},
    );
  }
